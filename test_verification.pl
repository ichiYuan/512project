img_verify(id44,right_pad,502).
img_verify(id44,right_pad,50).
img_verify(id30,pos,left).
img_verify(id30,pos,center).
img_verify(id50,aspect_ratio,17).
img_verify(id50,aspect_ratio,60).
